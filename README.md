...
<div>
<img src="images/Visualizations/age-bmi.png" alt="Scatter plot of t0 with x: age and y: bmi" width="500">
<br/><br/>
<figcaption><i><small>Fig. 3: Scatter plot of t0 with outliers (x-axis:age, y-axis:BMI)</small></i></figcaption>
</div>

<div style="text-align: center">
<img src="images/Visualizations/Age-ast.png" alt="Scatter plot of t0 with x: age and y: AST-Time" width="500">
<br/><br/>
